...
import isep.project.care4old.activity.ConsultLawtonActivity;
import isep.project.care4old.database.MyDatabase;
import isep.project.care4old.model.Lawton;


public class LawtonListAdapter extends BaseAdapter implements MyDatabase {

    public final static String LAWTON_TO_LAWTON = "isep.project.care4old.LAWTON_TO_LAWTON" ;

    private ArrayList<Lawton> listOfTest = new ArrayList<>();
    ...
    public LawtonListAdapter(ArrayList<Lawton> listOfTest, Context context, int idUser,int idDoctor) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        detail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent nextActivity = new Intent(getContext(), ConsultLawtonActivity.class);

                String[] extra = {String.valueOf(idUser),dateFormat.format(listOfTest.get(position).getDate()),String.valueOf(idDoctor)};

                nextActivity.putExtra(LAWTON_TO_LAWTON,extra) ;
